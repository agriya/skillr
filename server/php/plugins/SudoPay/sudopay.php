...
class SudoPay_API
{
    ...
    private $sandbox_api_url = 'http://sandbox.zazpay.com/api/v1';
    public $api_url;
    private $api_key = '';
    private $merchant_id = '';
    private $is_test = '';
    ...
    {
        $this->cache_path = dirname(dirname(dirname(dirname(dirname(__FILE__))))) . DIRECTORY_SEPARATOR . 'tmp' . DIRECTORY_SEPARATOR . 'cache' . DIRECTORY_SEPARATOR;
