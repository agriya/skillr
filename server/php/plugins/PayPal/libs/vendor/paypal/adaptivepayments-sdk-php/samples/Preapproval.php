			...
			<form id="Form1" name="Form1" method="post"
				...
				<div class="params">
					...
					<div class="param_value">
						<input name="returnUrl" id="returnUrl" value="<?php
echo $returnUrl; ?>" />
					</div>
				</div>
				<div class="params">
					...
					<div class="param_value">
						<input name="cancelUrl" id="cancelUrl" value="<?php
echo $cancelUrl; ?>" />
					</div>
				</div>
				<div class="params">
				...
				<div class="params">
					...
					<div class="param_value">
						<input name="startingDate" id="startingDate" value="<?php
echo date("Y-m-d"); ?>" />
					</div>
				</div>
				<div class="params">
					...
					<div class="param_value">
						<input name="endingDate" id="endingDate" value="<?php
echo date("Y-m-d", time() + 864000); ?>" />
					</div>
				</div>
				<div class="params">
