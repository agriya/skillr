...
for ($i = 0; $i < count($_POST['name']); $i++) {
    if ($_POST['name'][$i] != "" || $_POST['identifier'][$i] != "" || $_POST['price'][$i] != "" || $_POST['itemPrice'][$i] != "" || $_POST['itemCount'][$i] != "") {
...
if ($_POST['institutionId'] != "" || $_POST['firstName'] != "" || $_POST['lastName'] != "" || $_POST['displayName'] != "" || $_POST['institutionMail'] != "" || $_POST['institutionCustomerId'] != "" || $_POST['countryCode'] != "") {
...
if ($_POST['emailHeaderImageUrl'] != "" || $_POST['emailMarketingImageUrl'] != "" || $_POST['lastName'] != "" || $_POST['displayName'] != "") {
