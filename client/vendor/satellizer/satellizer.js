...
(function(window, angular, undefined, GENERAL_CONFIG) {
  'use strict';
  ...
  angular.module('satellizer', [])
    .constant('satellizer.config', {
      ...
      providers: {
        google: {
          url: api_url + 'api/v1/auth.json?type=google' ,
          authorizationEndpoint: 'https://accounts.google.com/o/oauth2/auth',
          redirectUri: window.location.origin + '/' || window.location.protocol + '//' + window.location.host,
          scope: ['https://www.googleapis.com/auth/plus.me https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email https://www.google.com/m8/feeds/'],
          scopePrefix: 'openid',
          scopeDelimiter: ' ',
		...
		youtube: {
          url: api_url + 'api/v1/auth.json?type=youtube' ,
          authorizationEndpoint: 'https://accounts.google.com/o/oauth2/auth',
          redirectUri: window.location.origin + '/' || window.location.protocol + '//' + window.location.host,
		...
		vimeo: {
          url: api_url + 'api/v1/auth.json?type=vimeo' ,
        ...
        facebook: {
          url: api_url + 'api/v1/auth.json?type=facebook' ,
        ...
        twitter: {
          url: api_url + 'api/v1/auth.json?type=twitter&method=post' ,
          type: '1.0',
        ...
        oauth.authenticate = function(name, isLinking, userData) {
          ...
          return provider.open(config.providers[name], userData || {})
            .then(function(response) {
              shared.setToken(response.data, isLinking);
              return response;
            });
      ...
      return function() {
        ...
        oauth1.exchangeForToken = function(oauthData, userData) {
          ...
          var qs = oauth1.buildQueryString(data);
		   var sep = defaults.url.indexOf('?') === -1 ? '?' : '&';
          return $http.get(defaults.url + sep + qs);
        };
